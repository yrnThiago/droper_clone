...
<template>
  ...
  <v-list>
    <v-list-item prepend-icon="mdi-magnify" title="Pesquisar" @click="redirectTo('/buscar')"></v-list-item>
  </v-list>
  <VDivider></VDivider>
  ...
  <v-list>
    <v-list-item v-for="item in aboutItems" :key="item.value" :prepend-icon="item.icon" :title="item.title" @click="redirectTo(item.route)"></v-list-item>
  </v-list>
  <VDivider></VDivider>

  <v-list>
    <v-list-item prepend-icon="mdi-brightness-2" title="Modo escuro" @click="showPopUpDarkMode = true"></v-list-item>
    <v-list-item prepend-icon="mdi-cog" title="Configurações" @click="redirectTo('/configuracoes')"></v-list-item>
  </v-list>
  <VDivider></VDivider>
