...
<template>
  ...
  <VAppBar flat app color="background-black">
    <VContainer fluid class="d-none d-sm-block">
      ...
      <VCol class="hidden-md-and-down ma-3" cols="1" align-self="center">
        <VImg
          ...
          alt="logo"
          src="https://droper.app/angular/img/logo.png"
          style="min-width=250px; width: 250px; height: 100%;"
      ...
      <VCol class="hidden-sm-and-down mr-12" cols="3" md="3" lg="2" align-self="center">
        ...
        <v-btn position="absolute" icon @click="redirectTo(`/market/loja/inicio`)">
          <v-icon>
      ...
      <VCol cols="3" md="2" lg="1">
        <SearchBar/>
      </VCol>

      <VAppBarNavIcon v-if="!drawer" @click.stop="drawer = !drawer" style="position: absolute ;right: 0px;"></VAppBarNavIcon>
      </VRow>
    </VContainer>
